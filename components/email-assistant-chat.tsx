    ...
    initialMessages: [
      {
        ...
        }! 👋 I'm **Inbox Buddy**, your personal AI email assistant with **REAL Gmail access**!
          ...
          {!hasGmailAccess && (
            <Alert className='m-4 mb-0'>
              ...
              <AlertDescription>
                ...
                full email analysis and management features.
                <Button
                  ...
                  <div className='bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200'>
                    <div className='flex items-center space-x-2'>
                      ...
                      <span className='text-sm text-gray-600'>
                        {hasGmailAccess
                          ? "Analyzing your real emails..."
                          : "Inbox Buddy is thinking..."}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className='border-t p-4 bg-gradient-to-r from-blue-50 to-purple-50'>
              <div className='flex items-center space-x-2 mb-3'>
                ...
                <span className='text-sm font-medium text-gray-700'>
                  {hasGmailAccess
                    ? "Try asking about your real emails:"
                    : "Quick starts:"}
                </span>
              </div>
              <div className='flex flex-wrap gap-2'>
          ...
          <div className='border-t p-4 bg-white'>
            <form onSubmit={handleSubmit} className='flex space-x-3'>
              <div className='flex-1 relative'>
                <Input
                  ...
                  placeholder={
                    hasGmailAccess
                      ? "Ask me about your real emails... I can see your actual inbox! 📧"
                      : "Ask Inbox Buddy anything about email management... 💌"
                  }
                  disabled={isLoading}
            ...
            <div className='flex items-center justify-between mt-2 text-xs text-gray-500'>
              <span>
                ...
                {hasGmailAccess
                  ? " I can access your real emails!"
                  : " Sign in for full email access"}
              </span>
              <div className='flex items-center space-x-1'>
                ...
                ></div>
                <span>
                  {hasGmailAccess ? "Real Gmail connected" : "Limited access"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className='space-y-4'>
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                from your Gmail account. Please review all details before
                confirming.
              </AlertDescription>
            </Alert>
